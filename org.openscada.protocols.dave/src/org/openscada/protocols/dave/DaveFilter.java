...
import org.openscada.protocols.dave.DaveReadRequest.Request.AddressType;
...
public class DaveFilter extends IoFilterAdapter
{
    ...
    private short startFactor ( final org.openscada.protocols.dave.DaveReadRequest.Request request )
    {
